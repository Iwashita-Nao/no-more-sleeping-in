  ...
  return (
    <div className="flex flex-col h-full animate-fade-in">
      ...
      <div className="flex items-center justify-between px-5 pt-8 pb-4">
        <div>
          <p className="text-xs font-semibold text-zinc-500 uppercase tracking-widest">Monitoring Active</p>
          <h2 className="text-white font-bold text-lg mt-0.5">Detecting movement…</h2>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 gap-6">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-zinc-400 text-sm mt-1">remaining</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 w-full">
          <div className="glass-card rounded-2xl p-4 text-center">
            ...
            <div className="text-xs text-zinc-400 mt-1">Times Triggered</div>
          </div>
          <div className="glass-card rounded-2xl p-4 text-center">
            <div className="text-3xl font-black text-emerald-400">
              {Math.round((totalSeconds - remaining) / 60)}m
            </div>
            <div className="text-xs text-zinc-400 mt-1">Elapsed</div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl px-5 py-3 flex items-center gap-3 w-full">
          ...
          <div>
            <p className="text-white text-sm font-semibold">Gyroscope active</p>
            <p className="text-zinc-400 text-xs">Keep phone flat on bed surface</p>
          </div>
